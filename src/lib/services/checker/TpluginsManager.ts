...
export class TpluginsManager extends TeventDispatcher {
	...
	releaseInstance( instance ){
		...
		//logger.error("instance released: "+instance.name+" length = "+this.pluginsInstances[instance.name].freeInstances.length)
	}
