...
export class Tchecker extends TbaseService {
	...
	constructor( name, server, config)
	{
		...
		app.config.models.Service.dao.class = TservicesDao
		app.config.models.Command.dao.class = TcommandsDao
