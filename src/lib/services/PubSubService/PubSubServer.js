...
class PubSubServer extends TbaseService_1.TbaseService {
    constructor(name, server, config) {
        ...
        this.cleanClientsTimer = new Ttimer_1.Ttimer({ delay: this.config.clientCleanInterval * 1000 });
        this.cleanClusterClientsTimer = new Ttimer_1.Ttimer({ delay: this.config.clientCleanInterval * 1000 });
    ...
    start() {
        super.start();
        this.cleanClientsTimer.on(Ttimer_1.Ttimer.ON_TIMER, this.onCleanClientsTimer, this);
        this.cleanClusterClientsTimer.on(Ttimer_1.Ttimer.ON_TIMER, this.onCleanClusterClientsTimer, this);
    ...
    stop() {
        ...
        this.cleanClientsTimer.off(Ttimer_1.Ttimer.ON_TIMER, this.onCleanClientsTimer);
        this.cleanClusterClientsTimer.off(Ttimer_1.Ttimer.ON_TIMER, this.onCleanClusterClientsTimer);
    }
    onIsMasterChanged(e) {
        if (e.data) {
