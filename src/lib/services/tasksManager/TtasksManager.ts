...
export class TtasksManager extends TbaseService {
    ...
    getRunningTaskByPID(pid: number) {
        var r = this.searchTask(function (t) {
            return (t.pid == pid);
        });
        return r;
    }
    getRunningTaskByID(id: string) {
        var r = null;
        if (typeof this.runningTasks[id] != "undefined")
    ...
    sendCallback(task, eventName: string, callback = null, attempts = 3) {
        var data = {
            task: task,
            event: "END",
    ...
    _startTask(req: express.Request, res: express.Response) {
        try {
    ...
    _startTaskSync(req: express.Request, res: express.Response) {
        try {
    ...
    _killTask(req: express.Request, res: express.Response) {
        try {
